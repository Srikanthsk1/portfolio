      ...
      <div className="container mx-auto px-8 lg:px-16 relative z-10">
        <div className="grid lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-16 items-center">
          <div className="order-2 lg:order-1 text-center lg:text-left space-y-8">
            <div className="inline-flex items-center gap-3 px-5 py-2 glass rounded-full border-cyan-500/15 animate-fade-in">
              <span className="relative flex h-3 w-3">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-cyan-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-3 w-3 bg-cyan-500"></span>
              </span>
              <span className="fira-code text-[11px] uppercase tracking-[0.35em] font-bold text-cyan-400/90">
            ...
            <div className="space-y-4">
              ...
              <h2 className="text-xl sm:text-2xl font-light text-slate-400 fira-code tracking-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-center justify-center lg:justify-start pt-4">
              ...
              <div className="flex items-center gap-4">
                <a
                  ...
                  className="w-14 h-14 glass rounded-lg flex items-center justify-center text-slate-400 hover:text-cyan-400 hover:border-cyan-500/40 transition-all duration-300 group/icon"
                >
                  <svg
                    className="w-6 h-6 group-hover/icon:scale-110"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-14 h-14 glass rounded-lg flex items-center justify-center text-slate-400 hover:text-indigo-400 hover:border-indigo-500/40 transition-all duration-300 group/icon"
                >
                  <svg
                    className="w-6 h-6 group-hover/icon:scale-110"
                    fill="currentColor"
          ...
          <div className="order-1 lg:order-2 flex justify-center items-center relative">
            <div className="relative group animate-float">
              <div className="absolute -inset-8 border border-cyan-500/8 rounded-full pointer-events-none"></div>

              <div className="relative w-[300px] h-[420px] sm:w-[350px] sm:h-[460px] lg:w-[400px] lg:h-[500px] rounded-[36px] overflow-hidden glass border-2 border-white/5 transition-all duration-700 hover:border-cyan-500/30 shadow-2xl">
                <img
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="flex flex-col gap-1">
                    <div className="fira-code text-[9px] text-cyan-400 font-bold uppercase tracking-[0.5em] mb-2">
                      Available to Hire
                    </div>
              ...
              <div className="absolute -right-6 top-[18%] glass px-5 py-3 rounded-xl border border-cyan-500/15 shadow-xl hidden lg:block backdrop-blur-xl group-hover:-translate-y-1 transition-transform">
                <div className="space-y-1">
                  <p className="text-[8px] fira-code text-slate-500 uppercase tracking-widest font-bold">
                    CODE
                  </p>
